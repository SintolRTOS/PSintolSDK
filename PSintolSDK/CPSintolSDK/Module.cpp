...
/************************************************************************/
/* author:wangjingyi
/* function:it's sdk for python to link rtosnode
/************************************************************************/
...
# define INITFUNCNAME PyInit_CPSintolSDK
# define INITERROR return NULL
#else
# define INITFUNCNAME initCPSintolSDK
...
#else
	PyObject* module = Py_InitModule3("CPSintolSDK", rti1516_methods, "rti1516 RTI/HLA backend implementation.");
#endif
